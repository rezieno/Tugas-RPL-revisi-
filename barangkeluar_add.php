...
<div class="subnav">
	<table border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td class="tabsubnav">
				<a href="?page=barangkeluar">DATA</a> &raquo; <b>TAMBAH BARANG KELUAR</b>
			</td>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="3">
	<form name="barangkeluar" action="?page=barangkeluar_add" method="post" onsubmit="return checkForm(this)">
		...
		<tr>
			...
			$arrayNamabrg=$bk->comboAmbilbarang();
...
<?php
	...
	$bk->tambahDataBk($_POST['kode_brg'],$_POST['jum_brg']);
